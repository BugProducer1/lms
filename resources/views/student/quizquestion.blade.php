                                    ...
                                    <div class="mb-2 mb-md-0">
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-lg me-3 flex-shrink-0">
                                                <img class="img-fluid rounded-3" src="{{ asset('img/students/quiz.jpg') }}"
                                                    alt="">
                                            </div>
                ...
                <div class="quiz-attempt-body p-0">
                    <div class="border p-3 mb-3 rounded-2">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="progress progress-xs  flex-grow-1 mb-1">
                                <div class="progress-bar bg-success rounded" role="progressbar" style="width: 40%;"
                ...
                <div class="quiz-attempt-body p-0">
                    <div class="border p-3 mb-3 rounded-2">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="progress progress-xs  flex-grow-1 mb-1">
                                <div class="progress-bar bg-success rounded" role="progressbar" style="width: 60%;"
                ...
                <div class="quiz-attempt-body p-0">
                    <div class="border p-3 mb-3 rounded-2">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="progress progress-xs  flex-grow-1 mb-1">
                                <div class="progress-bar bg-success rounded" role="progressbar" style="width: 80%;"
