                                            ...
                                            <ul>
                                                <li class="p-4 px-3 d-flex justify-content-between">
                                                    <p class="mb-0"><img class="me-2"
                                                            src="assets/img/icons/play.svg" alt="img">Lecture1.1
                                                ...
                                                <li class="p-4 px-3 d-flex justify-content-between">
                                                    <p class="mb-0"><img class="me-2"
                                                            src="assets/img/icons/play.svg" alt="img">Lecture1.2
                                                ...
                                                <li class="p-4 px-3 d-flex justify-content-between">
                                                    <p class="mb-0"><img class="me-2"
                                                            src="assets/img/icons/play.svg" alt="img">Lecture1.3
                                                ...
                                                <li class="p-4 px-3 d-flex justify-content-between">
                                                    <p class="mb-0"><img class="me-2"
                                                            src="assets/img/icons/play.svg" alt="img">Lecture1.4
                                                ...
                                                <li class="p-4 px-3 d-flex justify-content-between">
                                                    <p class="mb-0"><img class="me-2"
                                                            src="assets/img/icons/play.svg" alt="img">Lecture1.5
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div class="course-info align-items-center d-flex gap-2 gap-xl-3 mt-3 mb-3 flex-wrap">
                                ...
                                <p class="fw-medium d-flex align-items-center fs-14 mb-0"><img class="me-2"
                                        src="assets/img/icons/people.svg" alt="img">270,866 students enrolled</p>
                            </div>
                ...
                <div class="course-sidebar-sec mt-0">
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                ...
                                <p class="fs-14 mb-0"><span class="text-decoration-line-through me-2">$99.00</span>50%
                                    off</p>
                            </div>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <p class="mb-3"><img class="me-2" src="assets/img/icons/import.svg"
